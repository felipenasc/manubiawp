...
define('DB_NAME', 'manubiablog');

/** Usuário do banco de dados MySQL */
define('DB_USER', 'manubiablog');

/** Senha do banco de dados MySQL */
define('DB_PASSWORD', 'manubiablogpwd');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY', 'manubia:controle seu Dinheiro!275');
define('SECURE_AUTH_KEY', 'manubia:controle seu Dinheiro!275');
define('LOGGED_IN_KEY', 'manubia:controle seu Dinheiro!275');
define('NONCE_KEY', 'manubia:controle seu Dinheiro!275');
/**#@-*/
